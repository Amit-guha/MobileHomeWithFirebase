...
import com.example.mobilehome.studentfragment.GetTimeAgo;
import com.example.mobilehome.studentfragment.MessageAdapter;
...
public class StudentChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* //----ADDING ACTION BAR-----
        ...
        //Add custom toolbar
        Toolbar toolbar=findViewById(R.id.tvstudentchatbar);
        ...
        Window w= StudentChatActivity.this.getWindow();
        w.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        w.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        w.setStatusBarColor(ContextCompat.getColor(StudentChatActivity.this,R.color.white));
       ...
       /* TextView tooltv=findViewById(R.id.toolbarTextview);
        ...
        mLinearLayoutManager = new LinearLayoutManager(StudentChatActivity.this);
                    ...
                    mRootReference.updateChildren(messageUserMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                            ...
                            if (error != null) {
                                ...
                                Toast.makeText(StudentChatActivity.this, "Message sent", Toast.LENGTH_SHORT).show();
