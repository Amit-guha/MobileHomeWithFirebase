...
public class ChatRegestration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_regestration);
        ...
        progressDialog = new ProgressDialog(ChatRegestration.this);
    ...
    public void buttonIsClicked(View view) {
        ...
        if (view.getId() == R.id.button3) {
            ...
            if (displayname.equals("")) {
                Toast.makeText(ChatRegestration.this, "Please Fill the name", Toast.LENGTH_SHORT).show();
                return;
            }

            if (email.equals("")) {
                Toast.makeText(ChatRegestration.this, "Please Fill the email", Toast.LENGTH_SHORT).show();
                return;
            }

            if (password.length() < 6) {
                Toast.makeText(ChatRegestration.this, "Password is too short", Toast.LENGTH_SHORT).show();
                return;
            }
                        ...
                        public void onComplete(@NonNull Task<Void> task1) {
                            if (task1.isSuccessful()) {
                              ...
                              //  String Owner_id=getIntent().getStringExtra("userid");
                                Intent intent = new Intent(ChatRegestration.this, ChatLogin.class);
                              //  intent.putExtra("user_id",Owner_id);
                                ...
                                Toast.makeText(ChatRegestration.this, "YOUR NAME IS NOT REGISTERED... MAKE NEW ACCOUNT-- ", Toast.LENGTH_SHORT).show();
