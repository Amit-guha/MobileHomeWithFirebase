...
public class LoginPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window w= LoginPhone.this.getWindow();
        w.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        w.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        w.setStatusBarColor(ContextCompat.getColor(LoginPhone.this,R.color.white));
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LoginPhone.this);
        builder.setMessage("Do u Want to Exit?");
        builder.setTitle("Exit");
        builder.setCancelable(false);
        builder.setPositiveButton("Ok", new LoginPhone.MyLisitiner());
    ...
    public void buttonIsClicked(View view) {
        switch (view.getId()) {
            case R.id.buttonSign:
               ...
               // Toast.makeText(this, "" + email, Toast.LENGTH_SHORT).show();
                ...
                if (TextUtils.isEmpty(email) || TextUtils.isEmpty(password)) {
                    Toast.makeText(LoginPhone.this, "Please Fill all blocks", Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            case R.id.buttonRegister:
                ...
                Intent intent = new Intent(LoginPhone.this, RegestrationPhone.class);
                                ...
                                mDatabaseReference.child(user_id).updateChildren(addValue, new DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                        ...
                                        if (databaseError == null) {
                                            ...
                                            Intent intent = new Intent(LoginPhone.this, UpDelCheck.class);
                                            ...
                                            Toast.makeText(LoginPhone.this, databaseError.toString(), Toast.LENGTH_SHORT).show();
...
*/
                            ...
                            Toast.makeText(LoginPhone.this, "Wrong Credentials" +
