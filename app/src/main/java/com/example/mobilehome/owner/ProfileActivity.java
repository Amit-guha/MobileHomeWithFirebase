...
import com.example.mobilehome.EmailPassword;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        w.setStatusBarColor(ContextCompat.getColor(ProfileActivity.this,R.color.background));
        ...
        if(user_id==null){
            Intent intent = new Intent(ProfileActivity.this, EmailPassword.class);
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               ...
               // String display_image=snapshot.child("image").getValue().toString();
                ...
                mProfileStatus.setText("Phone No : "+display_status);
